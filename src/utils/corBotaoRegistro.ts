...
// sistema de cor de categoria: "Despesa", "Receita", "Veículo" e "TVDE" entram
// no COR_SEMANTICA como qualquer nome, e `cfg.categoriaCor` continua a mandar
...
/** As páginas que pintam o botão. Em qualquer outra ele fica no azul do app
 *  (`--blu`), que é o padrão do CSS. */
